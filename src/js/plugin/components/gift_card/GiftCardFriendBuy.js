    ...
    componentWillMount(){
        ...
        axios.get(this.state.baseUrl + 'gift-card/rest/group-buy/' + this.state.giftCardGroupBuyId)
            .then(response => {
                ...
                // console.log(response.data.giftCard.giftCardValue);

                this.setState({
                    item:           response.data,
                    iterator:       response.data.giftCard.giftCardValue/25,
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                ...
                                <div className="row">
                                    <div className="col">
                                        <h5 className="text-center">
                                            To buy this gift card successfully, {nickname} need find someone to buy another ${this.state.item.giftCard.giftCardValue - this.state.item.bought}
                                        </h5>
                                    </div>
                                </div>
                                <div className="row" style={{marginTop: '40px'}}>
